            ...
            <div class="leftBottom">
                <div class="basic-information">
                    ...
                    <div class="col-f">
                        ...
                        <input type="text" name="role" id="role" value="Department Head" readonly>
                    </div>
                    <div class="col-f">
...
<script>
        ...
        button.addEventListener('click', function(event) {
            ...
            switch (event.target.id) {
                ...
                case 'btnSaveEmployee':
                    const departmenthead = getFormdata("addDHForm");
                    ...
                    if (image) {
                        ...
                        postFiles('http://localhost/assetpro/departmentheads/addImage', formData, (data) => {
                            if (data.status == 'success') {
                                console.log(data);
                                departmenthead.image = data.imageUrl;
                                console.log(departmenthead);
                                saveDepartmentHead(departmenthead);
                            }
                        })
                    } else {
    ...
    function getFormdata() {
        form = new FormData(document.getElementById('addDHForm'));
        var departmenthead = {};
        for (var pair of form.entries()) {
            console.log(pair[0] + ': ' + pair[1]);
            departmenthead[pair[0]] = pair[1];
        }

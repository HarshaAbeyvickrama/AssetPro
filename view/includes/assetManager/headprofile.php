        ...
        <div id="pLeft" class="leftSection scrollBar"> 
            ...
            <div class="leftBottom">
                <div class="basic-information">
                    ...
                    <div class="col-f">
                        <span for="headID"> Department Head ID: </span>
                        <input type="text" name="headID" id="headID">
                    </div>
...
function formState(formId,readonlyState){
   ...
   var headDetails = getCookieValue('HeadDetails');
   var departmentHead = JSON.parse(headDetails);

//    console.log(employee.ProfilePicURL);

   document.getElementById('imagePrev').src = `..${departmentHead.ProfilePicURL}`;
    
   document.getElementById('headID').value = departmentHead.headID;
   document.getElementById('fName').value = departmentHead.fName;
   document.getElementById('lName').value = departmentHead.lName;
   document.getElementById('NIC').value = departmentHead.NIC;
   var radio = document.getElementById('radio-group').children;
    // console.log(employee.Gender);
   var gender = document.getElementById(departmentHead.Gender)
    // gender.checked = true;
    document.getElementById(departmentHead.Gender).checked = true;
    document.getElementById('dob').value = departmentHead.DOB;
    // document.getElementById('maritalStatus').value = employee.CivilStatus;
    document.getElementById('jobTitle').value = departmentHead.jobTitle;
    document.getElementById('address').value = departmentHead.Address;
    document.getElementById('contactNo').value = departmentHead.PhoneNumber;
    document.getElementById('email').value = departmentHead.Email;
    document.getElementById('eName').value = departmentHead.eName;
    document.getElementById('eRelationship').value = departmentHead.Relationship;
    document.getElementById('econtact').value = departmentHead.TelephoneNumber;

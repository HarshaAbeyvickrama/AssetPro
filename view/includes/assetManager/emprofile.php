...
<script>
    ...
    getData(`http://localhost/assetpro/employees/getEmployee/${employeeID}`, (employee) => {
        ...
        document.getElementById('empID').value = `EMP/${employee.EmployeeID}`;
        ...
        document.getElementById('eRelationship').value = employee.eRelationship;
        document.getElementById('econtact').value = employee.eContact;
